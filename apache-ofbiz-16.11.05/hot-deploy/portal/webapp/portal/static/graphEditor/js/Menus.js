...
Menus.prototype.defaultMenuItems = ['file', 'edit', 'view', 'arrange', 'extras', 'deploy','help'];
...
Menus.prototype.init = function () {
	...
	this.put('view', new Menu(mxUtils.bind(this, function (menu, parent) {
		this.addMenuItems(menu, ((this.editorUi.format != null) ? ['formatPanel'] : []).
			concat(['outline', 'layers', '-', 'viewbasicpattern', '-', 'pageView', 'pageScale', '-', 'scrollbars', 'tooltips', '-',
	...
	this.put('deploy', new Menu(mxUtils.bind(this, function (menu, parent) {
		this.addMenuItems(menu, ['deploy']);
	})));
};
...
Menus.prototype.createPopupMenu = function (menu, cell, evt) {
	...
	if (!graph.isSelectionEmpty()) {
		...
		if (state != null) {
			...
			if (graph.getSelectionCount() == 1) {
				menu.addSeparator();
				this.addMenuItems(menu, ['editData', 'editPattData', 'editLink'], null, evt);
