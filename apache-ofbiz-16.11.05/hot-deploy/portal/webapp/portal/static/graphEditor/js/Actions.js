...
Actions.prototype.init = function () {
	...
	// this.addAction('defaultJsonData...', function () {
	// 	var cell = graph.getSelectionCell() || graph.getModel().getRoot();
	// 	ui.showDataDialog(cell);
	// }, null, null, 'something+++');
	...
	if (userRole == 'Administrator' || userRole == 'Deployer') {
		this.addAction('deploy', function () {
			data = mxUtils.getXml(editor.getGraphXml())
		...
		// $('.geMenubar').children()[6].remove();
		// document.querySelector('.geMenubar').children[6].remove()
		// document.querySelector('.geMenubar').removeChild(document.querySelector('.geMenubar').children[6])
		// mxPopupMenu.prototype.hideMenu = function(){}

		this.addAction('deploy', function () {
			alert("Only Administrator / Deployer can Deploy Graph");
		});
	}
