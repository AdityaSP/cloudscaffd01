...
Sidebar.prototype.init = function () {
	...
	// this.addAutoPattPalette(false);
	this.addAWSPalette(false);
	...
	// this.addStencilPalette('AWS', 'AWS Iot', dir + '/aws17/iot.xml', ';whiteSpace=wrap;html=1;fillColor=#D86613;strokeColor=#D86613;strokeWidth=1');

	this.addStencilPalette('AWS', 'AWS Analytics', dir + '/aws17/analytics.xml', ';whiteSpace=wrap;html=1;fillColor=#D86613;strokeColor=#D86613;strokeWidth=1');
	this.addStencilPalette('AWS', 'AWS Application Services', dir + '/aws17/application services.xml', ';whiteSpace=wrap;html=1;fillColor=#D86613;strokeColor=#D86613;strokeWidth=1');
	this.addStencilPalette('AWS', 'AWS Artificial Intelligence', dir + '/aws17/artificial intelligence.xml', ';whiteSpace=wrap;html=1;fillColor=#D86613;strokeColor=#D86613;strokeWidth=1');
	this.addStencilPalette('AWS', 'AWS Business Productivity', dir + '/aws17/business productivity.xml', ';whiteSpace=wrap;html=1;fillColor=#D86613;strokeColor=#D86613;strokeWidth=1');
	this.addStencilPalette('AWS', 'AWS Compute', dir + '/aws17/compute.xml', ';whiteSpace=wrap;html=1;fillColor=#D86613;strokeColor=#D86613;strokeWidth=1');
	this.addStencilPalette('AWS', 'AWS Contact Center', dir + '/aws17/contact center.xml', ';whiteSpace=wrap;html=1;fillColor=#D86613;strokeColor=#D86613;strokeWidth=1');
	this.addStencilPalette('AWS', 'AWS Database', dir + '/aws17/database.xml', ';whiteSpace=wrap;html=1;fillColor=#D86613;strokeColor=#D86613;strokeWidth=1');
	this.addStencilPalette('AWS', 'AWS Desktop And App Streaming', dir + '/aws17/desktop and app streaming.xml', ';whiteSpace=wrap;html=1;fillColor=#D86613;strokeColor=#D86613;strokeWidth=1');
	...
	this.addStencilPalette('AWS', 'AWS Migration', dir + '/aws17/migration.xml', ';whiteSpace=wrap;html=1;fillColor=#D86613;strokeColor=#D86613;strokeWidth=1');
	...
	if (this.enableTooltips && this.showTooltips) {
		if (this.currentElt != elt) {
			...
			var show = mxUtils.bind(this, function () {
				...
				var left = this.container.clientWidth + this.editorUi.splitSize + 3 + this.editorUi.container.offsetLeft + off.x;// Show the tooltip icon after the sidebar
...
Sidebar.prototype.addUmlPalette = function (expand) {
	...
	var fns = [
		...
		this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;html=1;', 180, 90,
			...
			'foreignKey</td></tr><tr><td></td><td>fieldname</td></tr></table>', 'Entity', null, null, dt + ' entity table'),
		this.addEntry(dt + 'object instance', function () {
	...
	this.addPaletteFunctions('uml', mxResources.get('advanced'), expand || false, fns);
};



/** ???
 * Adding custom pallete
*/
Sidebar.prototype.addAutoPattPalette = function (expand) {
	// Avoids having to bind all functions to "this"
	var sb = this;
	...
	var fns = [
		this.createVertexTemplateEntry('html=1;', 110, 50, dt + '<b>Name</b>', 'Interface', null, null, dt + 'interface object instance annotated annotation'),
		this.addEntry(dt + 'object instance', function () {
			var cell = new mxCell(dt + 'Classname', new mxGeometry(0, 0, 160, 90),
				'swimlane;fontStyle=1;align=center;verticalAlign=top;childLayout=stackLayout;horizontal=1;startSize=26;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;');
			cell.vertex = true;
			cell.insert(field.clone());
			cell.insert(divider.clone());
		...
		this.addEntry(dt + 'section subsection', function () {
			var cell = new mxCell(dt + 'Classname', new mxGeometry(0, 0, 140, 110),
				'swimlane;fontStyle=0;childLayout=stackLayout;horizontal=1;startSize=26;fillColor=none;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;');
			cell.vertex = true;
			cell.insert(field.clone());
			cell.insert(field.clone());
		...
		this.createVertexTemplateEntry('text;align=center;fontStyle=1;verticalAlign=middle;spacingLeft=3;spacingRight=3;strokeColor=none;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;',
			80, 26, dt + 'Title', 'Title', null, null, dt + 'title label'),

		this.createVertexTemplateEntry('shape=note;whiteSpace=wrap;html=1;size=14;verticalAlign=top;align=left;spacingTop=-6;', 120, 60, dt + 'Note', 'Note', null, null, dt + 'aws note'),


		this.addEntry(dt + 'component', function () {
			var cell = new mxCell(dt + '&laquo;Annotation&raquo;<br/><b>Component</b>', new mxGeometry(0, 0, 180, 90), 'html=1;');
			cell.vertex = true;
		...
		this.addEntry(dt + 'component', function () {
			var cell = new mxCell(dt + '<p style="margin:0px;margin-top:6px;text-align:center;"><b>Component</b></p>' +
				'<hr/><p style="margin:0px;margin-left:8px;">+ Attribute1: Type<br/>+ Attribute2: Type</p>', new mxGeometry(0, 0, 180, 90),
				'align=left;overflow=fill;html=1;');
			cell.vertex = true;
		...
		this.createVertexTemplateEntry('verticalAlign=top;align=left;spacingTop=8;spacingLeft=2;spacingRight=12;shape=cube;size=10;direction=south;fontStyle=4;html=1;',
			180, 120, dt + 'Block', 'Block', null, null, dt + 'block'),
		this.createVertexTemplateEntry('shape=component;align=left;spacingLeft=36;', 120, 60, dt + 'Module', 'Module', null, null, dt + 'module'),
		this.createVertexTemplateEntry('shape=component;align=left;spacingLeft=36;', 140, 70, dt + 'Web App API GW', 'Module', null, null, dt + 'module'),
		this.createVertexTemplateEntry('html=1;shape=component;align=left;spacingLeft=36;', 140, 70, dt + 'Monitoring<br>Component', 'Module', null, null, dt + 'module'),
		this.createVertexTemplateEntry('html=1;shape=component;align=left;spacingLeft=36;', 140, 70, dt + 'App Service<br>Mesh', 'Module', null, null, dt + 'module'),
		/*
				this.createVertexTemplateEntry('shape=folder;fontStyle=1;spacingTop=10;tabWidth=40;tabHeight=14;tabPosition=left;html=1;', 70, 50,
					dt + 'package', 'Package', null, null, dt + 'package'),
				this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;',
					160, 90, dt + '<p style="margin:0px;margin-top:4px;text-align:center;text-decoration:underline;"><b>Object:Type</b></p><hr/>' +
				'<p style="margin:0px;margin-left:8px;">field1 = value1<br/>field2 = value2<br>field3 = value3</p>', 'Object',
					null, null, dt + 'object instance'),
				this.createVertexTemplateEntry('verticalAlign=top;align=left;overflow=fill;html=1;', 180, 90, dt +
					'<div style="box-sizing:border-box;width:100%;background:#e4e4e4;padding:2px;">Tablename</div>' +
					'<table style="width:100%;font-size:1em;" cellpadding="2" cellspacing="0">' +
					'<tr><td>PK</td><td>uniqueId</td></tr><tr><td>FK1</td><td>' +
					'foreignKey</td></tr><tr><td></td><td>fieldname</td></tr></table>', 'Entity', null, null, dt + ' entity table'),
				this.addEntry(dt + 'object instance', function () {
					var cell = new mxCell(dt + '<p style="margin:0px;margin-top:4px;text-align:center;">' +
						'<b>Class</b></p>' +
						'<hr size="1"/><div style="height:2px;"></div>', new mxGeometry(0, 0, 140, 60),
						'verticalAlign=top;align=left;overflow=fill;fontSize=12;fontFamily=Helvetica;html=1;');
					cell.vertex = true;
				...
				this.createVertexTemplateEntry('shape=providedRequiredInterface;html=1;verticalLabelPosition=bottom;', 20, 20, dt + '', 'Provided/Required Interface', null, null, 'uml provided required interface lollipop notation'),
				this.createVertexTemplateEntry('shape=requiredInterface;html=1;verticalLabelPosition=bottom;', 10, 20, dt + '', 'Required Interface', null, null, 'uml required interface lollipop notation'),
				this.addEntry('uml lollipop notation provided required interface', function () {
					return sb.createVertexTemplateFromData('',
						40, 10, dt + 'Lollipop Notation');
				}),
				this.createVertexTemplateEntry('shape=umlBoundary;whiteSpace=wrap;html=1;', 100, 80, dt + 'Boundary Object', 'Boundary Object', null, null, 'uml boundary object'),
				this.createVertexTemplateEntry('ellipse;shape=umlEntity;whiteSpace=wrap;html=1;', 80, 80, dt + 'Entity Object', 'Entity Object', null, null, 'uml entity object'),
				this.createVertexTemplateEntry('ellipse;shape=umlControl;whiteSpace=wrap;html=1;', 70, 80, dt + 'Control Object', 'Control Object', null, null, 'uml control object'),
				*/
		this.createVertexTemplateEntry('shape=umlActor;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;html=1;', 30, 60, dt + 'Actor', 'Actor', false, null, 'uml actor'),
		/*	this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;', 140, 70, dt + 'Use Case', 'Use Case', null, null, 'uml use case usecase'),
			this.addEntry('uml activity state start', function () {
				var cell = new mxCell(dt + '', new mxGeometry(0, 0, 30, 30),
					'ellipse;html=1;shape=startState;fillColor=#000000;strokeColor=#ff0000;');
				cell.vertex = true;
			...
			this.addEntry('uml activity state', function () {
				var cell = new mxCell(dt + 'Activity', new mxGeometry(0, 0, 120, 40),
					'rounded=1;whiteSpace=wrap;html=1;arcSize=40;fontColor=#000000;fillColor=#ffffc0;strokeColor=#ff0000;');
				cell.vertex = true;
				...
				return sb.createVertexTemplateFromCells([cell, edge], 120, 100, dt + 'Activity');
			}),
			this.addEntry('uml activity composite state', function () {
				var cell = new mxCell(dt + 'Composite State', new mxGeometry(0, 0, 160, 60),
					'swimlane;html=1;fontStyle=1;align=center;verticalAlign=middle;childLayout=stackLayout;horizontal=1;startSize=30;horizontalStack=0;resizeParent=0;resizeLast=1;container=0;fontColor=#000000;collapsible=0;rounded=1;arcSize=30;strokeColor=#ff0000;fillColor=#ffffc0;swimlaneFillColor=#ffffc0;');
				cell.vertex = true;
			...
			this.addEntry('uml activity condition', function () {
				var cell = new mxCell(dt + 'Condition', new mxGeometry(0, 0, 80, 40), 'rhombus;whiteSpace=wrap;html=1;fillColor=#ffffc0;strokeColor=#ff0000;');
				cell.vertex = true;
			...
			this.addEntry('uml activity fork join', function () {
				var cell = new mxCell(dt + '', new mxGeometry(0, 0, 200, 10), 'shape=line;html=1;strokeWidth=6;strokeColor=#ff0000;');
				cell.vertex = true;
			...
			this.createVertexTemplateEntry('ellipse;html=1;shape=endState;fillColor=#000000;strokeColor=#ff0000;', 30, 30, dt + '', 'End', null, null, 'uml activity state end'),
			*/
	];

	this.addPaletteFunctions('autopatt', mxResources.get('autopatt'), expand || false, fns);
};
...
Sidebar.prototype.addAWSPalette = function (expand) {
	...
	var fns = [
		this.createVertexTemplateEntry('html=1;', 110, 50, dt + '<b>App Service Mesh</b>', 'Interface', null, null, dt + 'interface object instance annotated annotation'),
		this.addEntry(dt + 'object instance', function () {
			var cell = new mxCell(dt + 'Classname', new mxGeometry(0, 0, 160, 90),
				'swimlane;fontStyle=1;align=center;verticalAlign=top;childLayout=stackLayout;horizontal=1;startSize=26;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;');
			cell.vertex = true;
		...
		this.addEntry(dt + 'ec2', function () {
			var cell = new mxCell(dt + '<b>EC2</b>', new mxGeometry(0, 0, 180, 90), 'html=1;');
			cell.vertex = true;

			var symbol = new mxCell('', new mxGeometry(1, 0, 20, 20), 'shape=ellipse;jettyWidth=8;jettyHeight=4;');
			symbol.vertex = true;
			symbol.geometry.relative = true;
			symbol.geometry.offset = new mxPoint(-27, 7);
			cell.insert(symbol);
		...
		this.addEntry(dt + 'ec2', function () {
			var cell = new mxCell(dt + '<b>Identity Services</b>', new mxGeometry(0, 0, 180, 90), 'html=1;');
			cell.vertex = true;
 ...
 * Azure Pallete
 */
// Sidebar.prototype.addAzurePalette = function (expand) {
// 	// Avoids having to bind all functions to "this"
// 	var sb = this;
...
// 	var fns = [
// 		this.createVertexTemplateEntry('html=1;', 110, 50, dt + '&laquo;interface&raquo;<br><b>Name</b>', 'Interface', null, null, dt + 'interface object instance annotated annotation'),
// 		this.addEntry(dt + 'object instance', function () {
// 			var cell = new mxCell(dt + 'Classname', new mxGeometry(0, 0, 160, 90),
// 				'swimlane;fontStyle=1;align=center;verticalAlign=top;childLayout=stackLayout;horizontal=1;startSize=26;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=1;marginBottom=0;');
// 			cell.vertex = true;
...
// 	this.addPaletteFunctions('azure', mxResources.get('azure'), expand || false, fns);
// };
	...
	ds.mouseUp = function (evt) {
		...
		if (value != '') {
			...
			if (value.split("-").length > 2) {
				str = value;
				lab = str.substr(str.indexOf("<b>") + 3, (str.indexOf("</b>") - str.indexOf("<b>") - 3)).toLowerCase().replace(/\s/g, '');
			} else {
				lab = value.split("-")[1];
			}
		...
		// graph.getModel().setValue(x, value);
...
function removeNumbers(str) {
	return str.replace(/[0-9]/g, ''); // Removing numbers
}

function removeTags(str) {
	return (str.substr(str.indexOf("<b>") + 3, (str.indexOf("</b>") - str.indexOf("<b>") - 3))).toLowerCase().replace(/\s/g, '');
}

function selectJSONdata(json, name) {
	if (name.search("<") >= 0) {
...
addCustomAttributes = function (json, type, name, value, graph, cell) {
	...
	if (json != null) {
		if (name.includes("<b>", 0)) {
			name = name.substr(name.indexOf("<b>") + 3, (name.indexOf("</b>") - name.indexOf("<b>") - 3));
		} else {
			name = name.replace("<br>", " ")
		}
		for (let i = 0; i < json.length; i++) {
			value.setAttribute(replaceSpecialCharacters(json[i]["name"]), replaceSpecialCharacters(json[i]["value"]));
		}
	}

	value.setAttribute("infraType", type);
	value.setAttribute("componentType", name);
...
Sidebar.prototype.createVertexTemplateEntry = function (style, width, height, value, title, showLabel, showTitle, tags) {
	...
	this.currentPallet = tags.split(" ")[0];
	return this.addEntry(tags, mxUtils.bind(this, function () {
		// alert("Checking")
