...
ArrangePanel.prototype.addGroupOps = function (div) {
	...
	if (graph.getSelectionCount() == 1) {
		...
		//???
		// btn = mxUtils.button('defaultJsonData', mxUtils.bind(this, function (evt) {
		// 	this.editorUi.actions.get('defaultJsonData').funct();
		// }));
		// btn.setAttribute('title', 'defaultJsonData' );//+ ' (' + this.editorUi.actions.get('editPattData').shortcut + ')');
		// btn.style.width = '100px';
		// btn.style.marginBottom = '2px';
		// div.appendChild(btn);
		// count++;
