...
Editor = function (chromeless, themes, model, graph, editable) {
	...
	this.graphChangeListener = function (sender, eventObject) {
		...
		// if (edit.changes[0].cell != null){
		// 	var rcell = edit.changes[0].cell;	
		// 	var value = this.graph.getModel().getValue(rcell);
		// 	var doc = mxUtils.createXmlDocument();
		// 	var obj = doc.createElement('object');
		// 	obj.setAttribute('label', value || '');
		// 	value = obj;
		// 	value = value.cloneNode(true)
		// 	value.setAttribute("Required", "Some value");
		// 	this.graph.getModel().setValue(rcell, value);
		// }
