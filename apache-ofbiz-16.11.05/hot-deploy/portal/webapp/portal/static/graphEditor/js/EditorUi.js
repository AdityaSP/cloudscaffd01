...
EditorUi = function (editor, container, lightbox) {
	...
	if (!graph.standalone) {
		...
		// 		xml =`<mxGraphModel dx="507" dy="633" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="850" pageHeight="1100"><root><mxCell id="0"/><mxCell id="1" parent="0"/><mxCell id="7" value="" style="edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;" edge="1" parent="1" source="2" target="6"><mxGeometry relative="1" as="geometry"/></mxCell><mxCell id="12" style="edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;exitX=0.25;exitY=1;exitDx=0;exitDy=0;" edge="1" parent="1"><mxGeometry relative="1" as="geometry"><mxPoint x="54.5" y="120" as="targetPoint"/><mxPoint x="54.5" y="70" as="sourcePoint"/></mxGeometry></mxCell><object label="&lt;b&gt;Name&lt;/b&gt;" infraType="aws" componentType="Name" id="2"><mxCell style="html=1;" vertex="1" parent="1"><mxGeometry x="20" y="20" width="110" height="50" as="geometry"/></mxCell></object><mxCell id="11" style="edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;exitX=0.5;exitY=1;exitDx=0;exitDy=0;entryX=0.713;entryY=-0.027;entryDx=0;entryDy=0;entryPerimeter=0;" edge="1" parent="1" source="6" target="4"><mxGeometry relative="1" as="geometry"/></mxCell><object label="&lt;b&gt;Name&lt;/b&gt;" infraType="aws" componentType="Name" id="6"><mxCell style="html=1;" vertex="1" parent="1"><mxGeometry x="265" y="20" width="110" height="50" as="geometry"/></mxCell></object><mxCell id="10" style="edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;exitX=0.5;exitY=0.5;exitDx=0;exitDy=0;exitPerimeter=0;" edge="1" parent="1" source="3"><mxGeometry relative="1" as="geometry"><mxPoint x="190" y="155" as="targetPoint"/><mxPoint x="50" y="119.5" as="sourcePoint"/></mxGeometry></mxCell><object label="Actor" infraType="aws" componentType="Actor" id="3"><mxCell style="shape=umlActor;verticalLabelPosition=bottom;labelBackgroundColor=#ffffff;verticalAlign=top;html=1;" vertex="1" parent="1"><mxGeometry x="40" y="125" width="30" height="60" as="geometry"/></mxCell></object><object label="&lt;b&gt;EC2&lt;/b&gt;" region="us-a" imageId="ami-0704c1f72e2fa523d" instance_type="t2.micro" key_name="ec2-Mongokeypair" infraType="aws" componentType="EC2" id="4"><mxCell style="html=1;" vertex="1" parent="1"><mxGeometry x="195" y="110" width="180" height="90" as="geometry"/></mxCell></object><mxCell id="5" value="" style="shape=ellipse;jettyWidth=8;jettyHeight=4;" vertex="1" parent="4"><mxGeometry x="1" width="20" height="20" relative="1" as="geometry"><mxPoint x="-27" y="7" as="offset"/></mxGeometry></mxCell></root></mxGraphModel>`;
		// var doc = mxUtils.parseXml(xml);
		// this.editor.graph.setSelectionCells(this.editor.graph.importGraphModel(doc.documentElement));
...
// EditorUi.prototype.hsplitPosition = (screen.width <= 640) ? 118 : ((urlParams['sidebar-entries'] != 'large') ? 450 : 578);
...
EditorUi.prototype.displayFetchedJson = function (jsonObj) {
	var that = this;
	if (jsonObj) {
		console.log(jsonObj);
		var res = that.json2Xml(jsonObj);
		// console.log(res)
		// that.displayFetchedXml(res);
...
EditorUi.prototype.refresh = function (sizeDidChange) {
	...
	// this.hsplit.style.left > 175; custom
...
EditorUi.prototype.saveFile = function (forceDialog) {
	if (!forceDialog && this.editor.filename != null) {
		...
		console.log("Resaving the same graph");
...
EditorUi.prototype.createKeyHandler = function (editor) {
	...
	if (!this.editor.chromeless || this.editor.editable) {
		...
		keyHandler.bindAction(74, true, 'editPattData'); // Ctrl+J
